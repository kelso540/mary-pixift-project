...
const toggleDarkMode = () => {
    if(body.style.backgroundColor === "rgb(42, 59, 73)"){
        ...
        // NOTES: menuIcon is not defined wasn't sure if you wanted it there
...
submitBtn.addEventListener("click", (e) => {
    ...
    const photoContainer = document.querySelector("#photo-submission-container");
    ...
    // NOTES: newEntry was labeled wrong here on insertBefore
    photoContainer.insertBefore(newEntry, photoContainer.firstChild);
